    ...
    <div className="w-full mb-10 sm:mb-20">
      {commonHeadDetails.map((commonHeadDetail) => (
        <div key={commonHeadDetail.id}>
          <h5
            data-aos="fade-up"
            className="font-[Poppins] font-semibold max-[640px]:text-[30px] max-[448px]:text-[25px] max-[640px]:leading-8  text-[40px]    leading-[45px] text-[#16205F] max-w-[609px] w-full mb-[21px]"
          >
